const MISAResource = {
  VN: {
    ...
    Sidebar: [
      {
        checked: true,
        caption: "Đăng ký mã số thuế",
        icon: "icon-sidebar-tax",
        link: "/salary",
      },
      {
        checked: false,
        caption: "Thông tin gia đình",
        icon: "icon-sidebar-family",
        link: "/salary",
      },
      {
        checked: false,
        caption: "Khai báo thuế kỳ",
        icon: "icon-sidebar-file",
        link: "/salary",
      },
      {
        checked: false,
        caption: "Thủ tục",
        icon: "icon-sidebar-procedure ",
        link: "/salary",
      },
      {
        checked: false,
        caption: "Quyết toán",
        icon: "icon-sidebar-tax-deduction",
        link: "/salary",
      },
      {
        checked: false,
